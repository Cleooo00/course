'''
Description: 
    Canny 是 1986 年发明的边缘检测算法。至今仍在计算机视觉中占有一定地位。Canny 算法的主要步骤如下：
    + 高斯滤波
    + 计算梯度
    + 非极大值抑制
    + 双阈值算法
LastEditTime: 2022-10-17 17:17:44
FilePath: \canny\cannyClass.py
'''
import numpy as np
import math
...
class Canny():
    ...
    # 双阈值检测 确定真实和潜在的边缘 通过抑制孤立的弱边缘最终完成边缘检测
